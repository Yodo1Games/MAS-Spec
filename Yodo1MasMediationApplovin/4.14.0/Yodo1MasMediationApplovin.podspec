...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.14.0/iOS/Release/Yodo1MasMediationApplovin-4.14.0.zip' }
...
sub.dependency 'Yodo1MasMediationApplovin/Amazon', '4.14.0'
end
