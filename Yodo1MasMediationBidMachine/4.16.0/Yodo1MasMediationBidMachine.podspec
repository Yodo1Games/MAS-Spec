...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.16.0/iOS/Release/Yodo1MasMediationBidMachine-4.16.0.zip' }
s.swift_version = '5.0'
...
sub.dependency 'Yodo1MasCore', '4.16.0'
sub.dependency 'BidMachine', '3.3.0'
end
s.subspec 'AppLovin' do |sub|
sub.dependency 'Yodo1MasMediationBidMachine/Core', '4.16.0'
