...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.18.0/iOS/Release/Yodo1MasMediationBidMachine-4.18.0.zip' }
  s.swift_version    = '5.0'
...
sub.dependency 'Yodo1MasMediationBidMachine/Core', '4.18.0'
