...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.15.1/iOS/Release/Yodo1MasMediationChartboost-4.15.1.zip' }
s.swift_version = '5.0'
...
sub.dependency 'Yodo1MasMediationChartboost/Core', '4.15.1'
