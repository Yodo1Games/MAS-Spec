...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.16.0/iOS/Release/Yodo1MasMediationChartboost-4.16.0.zip' }
s.swift_version = '5.0'
...
sub.dependency 'Yodo1MasMediationChartboost/Core', '4.16.0'
