...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.17.0/iOS/Release/Yodo1MasMediationTencent-4.17.0.zip' }
s.swift_version = '5.0'
...
sub.dependency 'Yodo1MasCore', '4.17.0'
...
sub.dependency 'Yodo1MasMediationTencent/Core', '4.17.0'
