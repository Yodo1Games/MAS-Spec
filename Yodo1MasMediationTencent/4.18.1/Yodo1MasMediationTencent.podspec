...
s.source = { :http => 'https://mas-artifacts.yodo1.com/4.18.1/iOS/Release/Yodo1MasMediationTencent-4.18.1.zip' }
  s.swift_version    = '5.0'
...
sub.dependency 'Yodo1MasCore', '4.18.1'
...
sub.dependency 'Yodo1MasMediationTencent/Core', '4.18.1'
